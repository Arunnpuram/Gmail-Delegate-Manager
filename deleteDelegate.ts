...
async function deleteDelegateAccount(): Promise<void> {
    try {
        ...
        const userEmails = await askQuestion('Enter the email(s) of the inbox(es) to impersonate (comma-separated): ');
        // Prompt for the email of the delegate
        const delegateEmails = await askQuestion('Enter the email(s) of the delegate(s) to delete (comma-separated): ');
